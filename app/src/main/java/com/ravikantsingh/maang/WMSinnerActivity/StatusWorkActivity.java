...
public class StatusWorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_status_work);
        list = new ArrayList<>();
        init();
        loadAndUpdateUI();
    }
    ...
    void init() {
        recyclerView = findViewById(R.id.status_work_recycler);
        adapter = new RecommendedWorkAdapter(this, list);
        mLayoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(mLayoutManager);
        recyclerView.setAdapter(adapter);
        reference = FirebaseDatabase.getInstance().getReference().child(StringVariables.WMS_REPORT).child("hajipur").child(StringVariables.WMS_STATUS);
    }
